...
adb shell pm enable com.blissos.setupwizard/com.blissos.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
...
sleep 1
adb shell am start com.blissos.setupwizard/com.blissos.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
    sleep 1
